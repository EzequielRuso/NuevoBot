...
║ *Link:* ${yt_play[0].url}\n
║
║ _. ᩭ✎Enviando ${additionalText}, Espere un momento_
╰─ ❖ ── ✦ ── ✧  ── ✧ ── ✦ ── ❖ ──┛`.trim()
...
await conn.reply(m.chat, '*✘error* _No pude descargar el Audio_ >:v', m)}}}}}
}  
if (command == 'play2') {
try {
let qu = '360'
...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `_NightcoreBot_`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
...
throw "_✘error✘_ _. ᩭ✎intentelo otra vez_"}
}
